      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6} md={4}>
          <MainCard title="Primary Color">
            ...
            <Stack>
              <ColorBox bgcolor="orange.lighter" data={{ label: 'Orange-1', color: '#fff7e6' }} title="orange.lighter" dark />
              <ColorBox bgcolor="orange.100" data={{ label: 'Orange-2', color: '#ffe7ba' }} title="orange[100]" dark />
              <ColorBox bgcolor="orange.200" data={{ label: 'Orange-3', color: '#ffd591' }} title="orange[200]" dark />
              <ColorBox bgcolor="orange.light" data={{ label: 'Orange-4', color: '#ffc069' }} title="orange.light" dark />
              <ColorBox bgcolor="orange.400" data={{ label: 'Orange-5', color: '#ffa940' }} title="orange[400]" />
              <ColorBox bgcolor="orange.main" data={{ label: 'Orange-6', color: '#fa8c16' }} title="orange.main" main />
              <ColorBox bgcolor="orange.dark" data={{ label: 'Orange-7', color: '#d46b08' }} title="orange.dark" />
              <ColorBox bgcolor="orange.700" data={{ label: 'Orange-8', color: '#ad4e00' }} title="orange[700]" />
              <ColorBox bgcolor="orange.darker" data={{ label: 'Orange-9', color: '#873800' }} title="orange.darker" />
              <ColorBox bgcolor="orange.900" data={{ label: 'Orange-10', color: '#612500' }} title="orange.900" />
            </Stack>
          </MainCard>
        </Grid>
        <Grid item xs={12} sm={6} md={4}>
